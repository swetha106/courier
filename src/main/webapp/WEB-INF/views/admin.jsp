...
<title>home</title>
    ...
    <body>
        <div class="image">V2V Couriers<br> <div class ="gety">Adding speed to your deliveries</div></div>
        
        <form action="add">
        <input class ="edit "type="submit"  value="Login"><br></form>
        
        <form action="remove">
        <input class ="edit "type="submit"  value="Track Order"><br></form>
